class DummyData {
  static final Map<String, Map<String, dynamic>> initialInventory = {
  ...
  static final List<Map<String, dynamic>> initialClients = [
  ...
  static final List<Map<String, dynamic>> initialComplaints = [
  ...
  static final List<Map<String, dynamic>> initialBillingHistory = [
  ...
  static final List<Map<String, dynamic>> initialNetworkNodes = [
  ...
  static final List<Map<String, dynamic>> initialTeamMembers = [
  ...
  static final List<Map<String, dynamic>> initialDepositReports = [
    {
      'id': 1,
      'kolektorId': 6,
  ...
  static final List<Map<String, dynamic>> initialExpenses = [
    {
      'id': 1,
      'type': 'out',
